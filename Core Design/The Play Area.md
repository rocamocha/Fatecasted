...
There are 2 zones in each player's play area:
1. Summons
2. Fatelines

Each player's Fate Pool and Character Pool should be easily accessible.

![[play_area.png]]

The combined area of all players' play areas is referred to as the battlefield.

> [!tip] About the Dice Box
> If you obtained a Fatecasted starter bundle, it should include a container lined with suede. This is meant to help you when rolling your dice, so that your dice don't go flying everywhere and potentially get mixed up with other player's dice. Everyone rolls at the same time in Fatecasted, so please use your dice box to make it easier for everyone!
> 
> Read more about this -> [[Packaging]]
